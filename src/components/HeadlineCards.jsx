    ...
    <div className='max-width-[1640px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6'>
      ...
      <div className='relative rounded-xl'>
        ...
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          ...
          <p className='px-2'>Order Time 8/26</p>
      ...
      <div className='relative rounded-xl'>
        {/* overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl  px-2 pt-4'>A Bite Of Bliss</p>
          <p className='px-2'>Order Time 8/26</p>
          <button className='border-white bg-white text-black mx-2 absolute bottom-4'>
            Order Now
          </button>
      ...
      <div className='relative rounded-xl'>
        {/* overlay */}
        <div className='absolute w-full h-full bg-black/50 rounded-xl text-white'>
          <p className='font-bold text-2xl  px-2 pt-4'>New Menu Available</p>
          <p className='px-2'>Order Time 8/26</p>
          <button className='border-white bg-white text-black mx-2 absolute bottom-4'>
            Order Now
          </button>
